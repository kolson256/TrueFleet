...
public interface ConfigurationStrategy<T extends Configuration> {
    ...
    /**
     * Returns the Stormpath configuration element from the specified service
     * configuration.
     *
     * @param configuration the service configuration
     * @return the Stormpath configuration
     */
    Optional<StormpathConfiguration> getStormpathConfiguration(T configuration);
